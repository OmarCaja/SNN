...
NeuralSystemPicker.save_neural_system('./resources/serialized_objects/multilayer_neural_network',
                                      multilayer_neural_network)
multilayer_neural_network = NeuralSystemPicker.load_neural_system(
    './resources/serialized_objects/multilayer_neural_network.snn')
